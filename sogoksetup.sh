...
echo -e "\e[33m──────────────────────────────────────────\033[0m"
echo -e "Developer   : Genome Store(${GREEN}Latest Edition${NC})"
echo -e "Copyright   : ${GREEN}Genome Store$(date +%Y)${NC}"
...
# LINK REPO
REPO="https://raw.githubusercontent.com/flowingwaters26/install/main/"
start=$(date +%s)
...
<code>──────────────────────────</code>
<code>Created By Genome Store $(date +%Y)</code>
<code>──────────────────────────</code>
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER SCRIPT","url":"https://t.me/bio_hazard89"}]]}'
...
Documentation=https://t.me/bio_hazard89
